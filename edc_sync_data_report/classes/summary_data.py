...
class SummaryData:
    ...
    def get_model_by_app_label_and_model_name(self, app_label, model_name, site_id,
                                              created_date):
        ...
        try:
            ...
            return model_cls.objects.filter(
                site__id=site_id, created__date=created_date).values_list('history_id',
                                                                          'created')
    ...
    def build_summary(self, site_id=None):
        ...
        for sync_model in sync_models:
            ...
            model_data = {f'{key}': self.count_by_app_label_and_model_name(
                sync_model.app_label, sync_model.model_name,
    ...
    def collect_primary_key_and_save(self, site_id=None, created_date=None):
        """
        Based on Sync models registered list, this method generates values list (id,
